-- ============================================
-- CORRECT IMAGE UPDATE - USING ACTUAL FILENAMES
-- These are the EXACT filenames from your public/images folder
-- ============================================
...
-- 5️⃣ BIRYANI MASALA (ID: 5) - FIXED: No space in filename
UPDATE products
SET 
...
-- 7️⃣ FLAXSEED CHUTNEY (ID: 7) - FIXED: No space in filename
UPDATE products
SET 
...
-- 8️⃣ COCONUT GARLIC CHUTNEY (ID: 8) - FIXED: No space in filename
UPDATE products
SET 
